	...
	bookElement.innerHTML = `
      ...
      <div class="book-data">
        ...
        <div class="space-between-container">
          ...
          <label for="read-state-${book.id}" class="read-toggle" data-id="${
		book.id
	}"></label>
          <span class="toggle-msg-${book.id}">${
...
bookFormSubmition.addEventListener('submit', () => {
	...
	const img = newBookCoverURL
		? newBookCoverURL
		: '/media/book-covers/default-cover.png';
	resetBookCoverURL();
...
booksContainer.addEventListener('click', (e) => {
	if (e.target.classList.contains('clear-card')) {
